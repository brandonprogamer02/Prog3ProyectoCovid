...
namespace WebApi_ConEntity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<tareacovidContext>(options => options.UseMySql("server=localhost;uid=root;pwd=mysql;database=tareacovid", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.18-mysql")));
